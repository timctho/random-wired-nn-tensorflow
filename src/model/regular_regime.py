...
class RegularRandWireNN(RandWire):
    def __init__(self, config, is_training=True):
        ...
        self.rand_wire_layer_3 = RandWireLayer(
            ...
            self.graph_def[2], graph_mode=config['Graph']['mode'], name='RandWire_3', is_training=is_training)
        ...
        if is_training:
            ...
            self.rand_wire_layer_3.save_graph(os.path.join(config['training_graph_path'], 'dag_3.txt'))
